...
def movies_with_director_key(name, movies_collection)
  ...
  while array_index < movies_collection.length do 
    ...
    new_collection << movie_with_director_name(name, movies_collection[array_index])
...
def gross_per_studio(collection)
  ...
  while collection_index < collection.length do 
    ...
    gross = collection[collection_index][:worldwide_gross]
...
def movies_with_directors_set(source)
  ...
  # 
  # [{ :name => "A", :movies => [{ :title => "Test" }] }, {:name => "A", :movies => [{ :title => "Test"}] }]
